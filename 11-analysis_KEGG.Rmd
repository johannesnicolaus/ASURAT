...
Input a formatted Gene Ontology database `tidy_KEGG` into the ASURAT object.
```{r, eval = FALSE}
...
between user's data and `tidy_KEGG`, and then excludes the IDs including too
...
pbmc_6000 <- do_quickQC_sign(obj = pbmc_6000, data_type = "KEGG",
                             min_ngenes = 2, max_ngenes = 1000)
```
The result is stored in `obj[["sign"]][["KEGG"]][["pathway"]]`.
...
```
The result is stored in `obj[["sign"]][["KEGGxSample"]][["pathway"]]`.
...
pbmc_6000 <- do_pca_sign(obj = pbmc_6000,
                         data_type = "KEGG", category = "pathway")
```
The result is stored in `obj[["reduction"]][["pca"]][["KEGG"]][["pathway"]]`.
...
pbmc_6000 <- do_tsne_sign(obj = pbmc_6000,
                          ...
                          pca_dim = NULL, tsne_dim = 2)
```
The result is stored in `obj[["reduction"]][["tsne"]][["KEGG"]][["pathway"]]`.
...
pbmc_6000 <- do_umap_sign(obj = pbmc_6000, data_type = "KEGG",
                          category = "pathway", pca_dim = NULL, umap_dim = 2)
```
The result is stored in `obj[["reduction"]][["umap"]][["KEGG"]][["pathway"]]`.
...
pbmc_6000 <- do_DiffusionMap_sign(obj = pbmc_6000, data_type = "KEGG",
                                  category = "pathway", pca_dim = NULL)
```
The result is stored in `obj[["reduction"]][["dmap"]][["KEGG"]][["pathway"]]`.
...
```{r, eval = FALSE}
# day7_hypo <- classify_samples_pam_sign(
#   obj = day7_hypo, data_type = "KEGG",category = "pathway", k = 2)

#
# Below is a memo for plotting the result.
#
# mat <- day7_hypo[["reduction"]][["tsne"]][["KEGG"]][["pathway"]]$Y
# lab <- day7_hypo[["sample"]][["pam_KEGG_pathway"]]
...
```{r, eval = FALSE}
# day7_hypo <- classify_samples_hclustCutree_sign(
#   obj = day7_hypo, data_type = "KEGG", category = "pathway",
#   method = "ward.D2", k = 2)
...
#
# mat <- day7_hypo[["reduction"]][["tsne"]][["KEGG"]][["pathway"]]$Y
# lab <- day7_hypo[["sample"]][["hclustCutree_KEGG_pathway"]]
# col <- rainbow(length(unique(lab)))
# plot(mat, pch=21, bg=col[lab])
# legend("bottomright", legend=unique(sort(lab)), pch=21, pt.bg=col)
```
...
day7_hypo <- classify_samples_seuratFindClusters_sign(
  obj = day7_hypo, data_type = "KEGG", category = "pathway", reduction = "pca",
  dims = 1:20, k.param = 10, prune.SNN = 1./15, resolution = 0.1,
  algorithm = 1)
...
# legend("bottomright", legend=unique(sort(lab)), pch=21, pt.bg=col)
```
The results are stored in `obj[["sample"]][["seuratFindClusters_KEGG_pathway"]]`
and `obj[["classification"]][["seuratFindClusters"]][["KEGG"]][["pathway"]]`.
...
Save the objects.
```{r, eval = FALSE}
saveRDS(day7_hypo, file = "backup/02_303_day7_hypo_classification_KEGG.rds")
...
Load the objects.
```{r, eval = FALSE}
day7_hypo <- readRDS(file = "backup/02_303_day7_hypo_classification_KEGG.rds")
...
# For `day7_hypo`
# ----------------------------------------
filename <- "figures/figure_02_0330.png"
png(file = filename, height = 1000, width = 1250, res = 200)
plot_Heatmap_SignxSamp(obj = day7_hypo,
                       data_type = "KEGG", category = "pathway",
                       algo_name = "seuratFindClusters", method = "ward.D2",
                       show_nReads = FALSE, title = "day7_hypo (KEGG: pathway)",
                       name = "KEGGxSamp",
...
<img src="figures/figure_02_0330.png" width="300px">
...
p <- plot_tsne_sign(obj = day7_hypo, data_type = "KEGG", category = "pathway",
                    ...
                    theta = NULL, phi = NULL,
                    title = "day7_hypo (KEGG: pathway)", title_size = 16,
                    xlabel = "tSNE_1", ylabel = "tSNE_2", zlabel = NULL,
                    default_color = FALSE)
filename <- "figures/figure_02_0331.png"
...
p <- plot_umap_sign(obj = day7_hypo, data_type = "KEGG", category = "pathway",
                    ...
                    xlabel = "UMAP_1", ylabel = "UMAP_2", zlabel = NULL,
                    default_color = FALSE)
filename <- "figures/figure_02_0332.png"
ggsave(file = filename, plot =  p, dpi = 250, width = 4.9, height = 4)
```
...
<img src="figures/figure_02_0331.png" width="250px">
<img src="figures/figure_02_0332.png" width="250px">
...
<img src="figures/figure_02_0335.png" width="150px">
...
```{r, eval = FALSE}
day7_hypo <- auto_find_marker_sign(obj = day7_hypo,
...
all other cells.
```{r, eval = FALSE}
datatable(day7_hypo[["marker"]][["KEGG"]][["pathway"]][["all"]],
          rownames = FALSE)
...
# ----------------------------------------
p <- plot_violin_signScore(
  obj = day7_hypo, sign_name = "path:hsa05165_S",
  data_type_for_label = "KEGG", category_for_label = "pathway",
  algo_name_for_label = "seuratFindClusters",
  data_type_for_expr = "KEGG", category_for_expr = "pathway",
  title = "KEGG:hsa05165_S\nHuman papillomavirus..\n(CDKN1A/COL6A1/..)",
  title_size = 16, default_color = FALSE)
filename <- "figures/figure_02_0341.png"
ggsave(file = filename, plot = p, dpi = 200, width = 4, height = 4)
...
<img src="figures/figure_02_0340.png" width="230px">
<img src="figures/figure_02_0341.png" width="230px">
...
Save the objects.
```{r, eval = FALSE}
saveRDS(day7_hypo, file = "backup/02_304_day7_hypo_DES_KEGG.rds")
...
Load the objects.
```{r, eval = FALSE}
day7_hypo <- readRDS(file = "backup/02_304_day7_hypo_DES_KEGG.rds")
